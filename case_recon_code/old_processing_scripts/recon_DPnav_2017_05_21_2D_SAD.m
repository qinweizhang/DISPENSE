...
save traj_Sc8-9.mat trj_meas_kx trj_meas_ky trj_meas_kz
%% Recon with measured Trajecotry 
clear
fn = 'dp_21052017_1615594_9_2_wipdpstitseexperiment1senseV4.raw';
...
save('data_Sc8_2D.mat', 'nav_k_spa_data', '-append')


%% LOAD DATA
clear; close all;  load('traj_Sc6-7.mat'); load('data_Sc9_2D.mat')
...
skip_point =1;
end_point =5000 %length(trj_meas_kx);
...
scale_foctor_kx_ky = max([16/max(abs(trj_meas_kx)),16/max(abs(trj_meas_ky))]);
