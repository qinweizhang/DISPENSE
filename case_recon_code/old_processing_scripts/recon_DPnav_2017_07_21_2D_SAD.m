...
clear
fn = 'so_19072017_0914113_9_2_wip_dpsti_sosad_linearV4.raw';
...
%% NUFFT recon.  3D
clear; close all; clc;
load('traj_Sc4_5_8.mat'); load('data_Sc09_3D.mat')
%scle trajectory to match kx_range, ky_range (-pi to pi)
ignore_kz = 0; 
recon_dim  = [24 24 15];
...
for shot_nr = 1: size(nav_k_spa_data,3)
    ...
    for ch =1:size(nav_k_spa_data,2)
        ...
        nav_im_recon_nufft(:,:,:,ch,shot_nr)=regularizedReconstruction(A,sig_nufft','maxit',25);
    end
