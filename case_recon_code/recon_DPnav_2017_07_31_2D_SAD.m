...
close all; clear; clc;
trj_save_fn = 'traj_Sc8_9_10.mat';
spira_3D_trjectory_calculation(trj_save_fn, 15);


%% TSE image and spiral Nav. data loading
clear
fn = 'dp_31072017_1937247_8_2_wip_dpsti_sosad_linear-ppuV4.raw';
save_fn = 'data_Sc08_3D.mat';
...
data_fn = 'data_Sc08_3D.mat';
trj_fn = 'traj_Sc8_9_10.mat'; 

%=============== recon parameters =========================
recon_par.ignore_kz = 0;
recon_par.recon_dim  = [24 24 18];
recon_par.dyn_nr = 1;
...
recon_par.data_fn = 'dp_31072017_1937247_8_2_wip_dpsti_sosad_linear-ppuV4.raw';
...
bart_recon.recon_dim = [24, 24, 18];
bart_recon.trj_scale_dim = [24, 24, 12];
