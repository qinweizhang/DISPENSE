...
clear; clc; close all
cd('/home/qzhang/lood_storage/divi/Ima/parrec/Kerry/Data/2017_12_09_3D_spiral')
...
gr_waveform = dlmread('No3_external_spiral_GRwaveforms.dat');  %in mT/m
...
data_fn = 'sp_09122017_1759146_6_2_wip_3dspiral_brainV4.raw';
sense_ref_fn = 'sp_09122017_1744094_1000_11_wip_senserefscanV4.raw';
coil_survey_fn  = 'sp_09122017_1741042_1000_8_wip_coilsurveyscanV4.raw';
...
AQ_samples = 6048;     %<<<<<set this
AQ_interval = 0.0046; %<<<<<set this
...
figure(6); plot(dist./max(abs(dist(:))));
hold on
...
for d = 1:length(dyn_recon)
    ...
    recon_par.acq_dim = [44 44 24];  
    recon_par.recon_dim  = [44 44 24];
