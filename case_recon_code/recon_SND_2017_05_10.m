...
clear;clc; close all;
cd('/home/qzhang/lood_storage/divi/Ima/parrec/Kerry/Data/2017_05_10_DPnav SoSAD 2D Phantom');
...
data_fn = 'dp_10052017_1627242_5_2_wip3ddpnavlinearexperiment1senseV4.raw';
sense_ref_fn = 'dp_10052017_1615304_1000_5_wipsenserefscanexperiment1clearV4.raw';
coil_survey_fn  = 'dp_10052017_1613579_1000_2_wipcoilsurveyscanV4.raw';

trj_mat_fn = 'traj_Sc8-9.mat';
...
for dyn = 1:dyn_nr
    ...
    recon_par.end_point = 1600; %[]; %or []: till the end;
...
figure(606); immontage4D(permute(abs(ima_default_recon(:,:,:,:)),[1 2 4 3]), []);
disp('-finished- ');
...
TSE_sense_map = ones(128, 64, 12, 14);
...
pars.enabled_ch = [1 2];
pars.b0_shots = [];
pars.nonb0_shots = 1:3:54;
pars.recon_x_locs = 1:128;
