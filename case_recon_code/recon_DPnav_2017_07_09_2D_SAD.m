...
save traj_Sc3_4_11.mat trj_meas_kx trj_meas_ky trj_meas_kz
%% Recon with measured Trajecotry 
clear
fn = 'dp_09072017_1523173_10_2_wip_dpsti_sad_2dV4.raw';
...
%% LOAD DATA
clear; close all;  load('traj_Sc3_4_7.mat'); load('data_Sc2_2D.mat')
...
%% NUFFT recon.  3D
clear; close all; clc;
load('traj_Sc3_4_11.mat'); load('data_Sc10_2D.mat')
%scle trajectory to match kx_range, ky_range (-pi to pi)
shot_nr = 1; 
diffusion_nr =2;
...
for ch =1:size(nav_k_spa_data,2)
    sig_nufft = double(sig_kspa(:, ch));
    sig_nufft = sig_nufft';
    A=nuFTOperator(trj_nufft,[24, 24, 15],ones(24, 24, 15),6);
