...
clear; clc; close all
cd('/home/qzhang/lood_storage/divi/Ima/parrec/Kerry/Data/2017_11_26_3D_spiral')
%% trajectory calculation
close all; clear; clc;
trj_save_fn = 'traj_for_Sc12_19.mat';
...
data_fn = 'ph_26112017_1854391_19_2_wip_3d_sosV4.raw';
sense_ref_fn = 'ph_26112017_1704562_1000_5_wip_senserefscanV4.raw';
coil_survey_fn  = 'ph_26112017_1703596_1000_2_wip_coilsurveyscanV4.raw';

trj_mat_fn = 'traj_for_Sc12_19.mat';
...
for d = 1:length(dyn_recon)
    ...
    recon_par.acq_dim = [19 19 16];  
    recon_par.recon_dim  = [19 19 16];
    recon_par.dyn_nr = dyn;
    recon_par.skip_point = 56 ;
