...
clear
fn = 'dp_17052017_1422549_11_2_wipsc23ddpnavlinearexperiment1senseV4.raw';
...
save('data_Sc11_2D.mat', 'nav_k_spa_data', '-append')


%% LOAD DATA
clear; close all;  load('traj_Sc8-9.mat'); load('data_Sc11_2D.mat')
