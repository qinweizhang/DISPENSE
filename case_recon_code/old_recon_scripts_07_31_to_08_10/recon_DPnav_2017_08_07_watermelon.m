...
clear;clc; close all;
cd('/home/qzhang/lood_storage/divi/Ima/parrec/Kerry/Data/2017_08_07_SoSAD_watermelon');
...
clear
fn = 'dp_07082017_2105182_14_2_wip_sc4_dpsti_sosad_linear-ppuV4.raw';
save_fn = 'data_Sc14_3D.mat';
...
recon_par.interations = 30;
recon_par.sense_map_recon = 1;
recon_par.update_SENSE_map = 0;
recon_par.sense_calc_method = 'external'; %'ecalib' or 'external'
recon_par.data_fn = 'dp_07082017_1930388_4_2_wip_sc4_dpsti_sosad_linear-ppuV4.raw';
recon_par.sense_ref = 'dp_07082017_2022075_1000_15_wip_senserefscanV4.raw';
recon_par.coil_survey = 'dp_07082017_2018349_1000_10_wip_coilsurveyscanV4.raw';
%========================  END  =========================
