...
clear; clc; close all
cd('/home/qzhang/lood_storage/divi/Users/qzhang/Data/2018_03_14_SND_brain_V4')
...
data_fn         = 'sn_14032018_1747384_4_2_wip_sc2_3d_snd_brain_4bV4.raw';
sense_ref_fn    = 'sn_14032018_1719388_1000_5_wip_senserefscanV4.raw';
coil_survey_fn  = 'sn_14032018_1715022_1000_2_wip_coilsurveyscanV4.raw';
...
for d = 1:length(dyn_recon)
    ...
    recon_par.acq_dim = [40 40 24];  
    recon_par.recon_dim  = [40 40 24];
    recon_par.dyn_nr = dyn;
    recon_par.skip_point = 0 ;
    recon_par.end_point = []; %or []: till the end;
    recon_par.interations =25;
    recon_par.lamda = 0;
...
%         
        ...
        if(exist('Nav_VirtualCoilMartix','var'))
            if(~isempty(Nav_VirtualCoilMartix))
                [nav_sense_map, nav_sense_Psi] = compress_sense_map_Psi(Nav_VirtualCoilMartix, nav_sense_map_raw, nav_sense_Psi_raw);
            end
        end
    end
