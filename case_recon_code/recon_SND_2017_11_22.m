...
clear; clc; close all
cd('/home/qzhang/lood_storage/divi/Ima/parrec/Kerry/Data/2017_11_22_SND_cadiac/')
...
data_fn = 'sp_22112017_1428393_8_2_wip_sc14-dpsti-tseV4.raw';
sense_ref_fn = 'sp_22112017_1410186_1000_16_wip_senserefscanV4.raw';
coil_survey_fn  = 'sp_22112017_1401587_1000_8_wip_coilsurveyscanV4.raw';
...
for d = 1:length(dyn_recon)
    ...
    recon_par.acq_dim = [48 48 18];  
    recon_par.recon_dim  = [48 48 18];
