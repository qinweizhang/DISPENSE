...
clear
fn = 'dp_10052017_1648554_9_2_wip3ddpnavlinearexperiment1senseV4.raw';
...
save data_Sc9_2D.mat nav_k_spa_data


%% LOAD DATA
clear; close all;  load('traj_Sc8-9.mat'); load('data_Sc3_2D.mat')
...
skip_point =111;
end_point = 2000; %size(trj_meas_kx,1);
