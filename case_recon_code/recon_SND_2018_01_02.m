...
clear; clc; close all
cd('/home/qzhang/lood_storage/divi/Ima/parrec/Kerry/Data/2018_01_02_SND_carotid')
...
data_fn = 'sn_02012018_2039450_4_2_wip_sc2_3d_snd_carotidV4.raw';
sense_ref_fn = 'sn_02012018_2019504_1000_5_wip_senserefscanV4.raw';
coil_survey_fn  = 'sn_02012018_2019013_1000_2_wip_coilsurveyscanV4.raw';
...
for d = 1:length(dyn_recon)
    ...
    recon_par.acq_dim = [28 28 12];  
    recon_par.recon_dim  = [28 28 12];
