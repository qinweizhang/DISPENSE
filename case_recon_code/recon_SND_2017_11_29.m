...
clear; clc; close all
cd('/home/qzhang/lood_storage/divi/Ima/parrec/Kerry/Data/2017_11_29_3D_spiral')
...
data_fn = 'ca_29112017_1836040_8_2_wip_3d_brain_cardiacV4.raw';
sense_ref_fn = 'ca_29112017_1831586_1000_8_wip_senserefscanV4.raw';
coil_survey_fn  = 'ca_29112017_1823078_1000_2_wip_coilsurveyscanV4.raw';

trj_mat_fn = 'traj_for_tra.mat';
...
for d = 1:length(dyn_recon)
    ...
    nav_im_recon_nufft_1dyn = NUFFT_3D_recon(nav_k_spa_data(:,1:13,:,:),trj_mat_fn,recon_par, nav_sense_map(:,:,:,1:13), nav_sense_Psi,offcenter_xy, FOV_xy);
