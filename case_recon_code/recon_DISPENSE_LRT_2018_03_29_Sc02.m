...
nav_data = reshape(nav_im_recon_nufft(:,:,:,1,1:50,:), size(nav_im_recon_nufft,1), size(nav_im_recon_nufft, 2), size(nav_im_recon_nufft, 3), max(TSE.shot_matched));
...
pars.msDWIrecon.method='LRT'; %POCS_ICE CG_SENSE_I CG_SENSE_K LRT
