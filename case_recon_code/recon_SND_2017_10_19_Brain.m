...
clear; clc; close all
cd('/home/qzhang/lood_storage/divi/Ima/parrec/Kerry/Data/2017_10_19_SND_brain')
%% trajectory calculation
close all; clear; clc;
trj_save_fn = 'traj_for_Sc9.mat';
...
data_fn = 'sn_19102017_1848105_2_2_wip_sc5_3d_snd_brain_4bV4.raw';
sense_ref_fn = 'sn_19102017_1847383_1000_5_wip_senserefscanV4.raw';
coil_survey_fn  = 'sn_19102017_1844503_1000_2_wip_coilsurveyscanV4.raw';

trj_mat_fn = 'traj_for_Sc2_3_7.mat';
...
for d = 1:length(dyn_recon)
    ...
    nav_im_recon_nufft_78 = nav_im_recon_nufft;
    save Sc02.mat nav_im_recon_nufft_78  -append
    toc
end
...
for d = [2:9]
    ...
    save('Sc02.mat','image_corrected','-append');
end
