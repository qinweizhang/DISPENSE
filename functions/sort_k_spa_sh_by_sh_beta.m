...
function kspa_sortted = sort_k_spa_sh_by_sh_beta(ima_k_spa_data, shot_range, TSE, pars)
...
padding_left = floor(padding_size/2);

kx_sort_range = padding_left+1:padding_left+size(kspa_temp,1);


kspa_sortted(kx_sort_range,:,:,:,:) = kspa_temp;
